      ...
      <section className="about-hero">
        <div className="container">
          ...
          <p className="page-subtitle">
            Your trusted automotive partner for over 20 years
          </p>
        </div>
      </section>

      {/* Meet Mike Section - Modern Overlapping Design */}
      <section className="meet-mike-section">
        <div className="container">
          <div className="meet-mike-modern">
            <div className="mike-image-container">
              <div className="mike-image-frame">
